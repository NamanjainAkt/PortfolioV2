...
const Postman = React.forwardRef<SVGSVGElement, IconProps>(({ className, size = 24, strokeWidth = 1.5, color, style }, ref) => (
  <svg
    ref={ref}
    className={className}
    width={size}
